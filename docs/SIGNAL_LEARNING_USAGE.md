...
first so missing next-day prices are visible before model training starts, and
verifies that file-backed LLM caching is available through
`OUTLOOK_LLM_CACHE_PATH`.
