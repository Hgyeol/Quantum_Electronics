...
DEV_DATA = [
    ...
    ("6-3. DB 기반 조건 평가", "6-3-1-1. 사전 수집된 일봉·투자자 데이터로 전체 종목을 검사한다.\n6-3-1-2. 거래량 급등·골든크로스·정배열·MACD·OBV 등 25종 조건을 계산한다.", "일봉 OHLCV, 투자자 데이터", "ScreenerResult", "스크리너 결과 목록", "services.screener_conditions"),
    ("6-4. 실시간 조건 평가", "6-4-1-1. 체결강도·신고가 근접·상한가 포착 3종은 KIS API로 실시간 조회한다.", "체결강도, 신고가, 상한가", "RankItem", "스크리너 결과 목록", "services.ranking"),
    ("6-5. 야간 데이터 수집 배치", "6-5-1-1. 전 종목 일봉 OHLCV와 투자자 데이터를 매일 수집해 SQLite에 저장한다.", "일봉 OHLCV, 투자자 데이터", "ScreenerDB", "", "services.screener_collector"),
